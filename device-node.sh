...
SERVICEPROVIDER_IP="10.53.108.121" # this is the external IP of the Service-Provider
...
device_registration() {
    ...
    #---------------------------------
    scp d_s_registration.txt root@$SERVICEPROVIDER_IP:$service_provider_location/.
    #---------------------------------    
...
#-----------------------------
    scp p_d_registration_token.txt root@$SERVICEPROVIDER_IP:$service_provider_location/d_s_registration_token.txt
#----------------------------
 
  # cp p_d_registration_token.txt $service_provider_location/d_s_registration_token.txt
...
#-------------------------
      scp d_s_service.txt root@$SERVICEPROVIDER_IP:$service_provider_location/.
      scp $device_service_aik root@$SERVICEPROVIDER_IP:$service_provider_location/d_s_service_aik.pub
#-------------------------
...
#-----------------------------  
    scp p_d_service_token.txt root@$SERVICEPROVIDER_IP:$service_provider_location/d_s_service_token.txt
#-----------------------------
...
process_device_software_state_validation_request() {
    ...
    scp attestation_quote.dat attestation_quote.signature pcr.bin root@$SERVICEPROVIDER_IP:$service_provider_location/.
...
process_encrypted_service_data_content() {
    ...
    tpm2 rsadecrypt -c service_content_key.ctx -o s_d_service_content.decrypted  -s oaep \
...
#-----------------------------------
     scp d_s_service_content_key.pub root@$SERVICEPROVIDER_IP:$service_provider_location/.
#-----------------------------------
    tpm2_sign \
        -c rsa_ak.ctx \
        -g sha256 \
    ...
    scp d_s_service_content_key_pub.sig root@$SERVICEPROVIDER_IP:$service_provider_location/.
